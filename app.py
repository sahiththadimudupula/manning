...
#                     format="%.2f",
#                 ),
#                 "General_Shift": st.column_config.NumberColumn(
#                     "General_Shift",
#                     format="%.2f",
#                 ),
#                 "Shift_A": st.column_config.NumberColumn(
#                     "Shift_A",
#                     format="%.2f",
#                 ),
#                 "Shift_B": st.column_config.NumberColumn(
#                     "Shift_B",
#                     format="%.2f",
#                 ),
#                 "Shift_C": st.column_config.NumberColumn(
#                     "Shift_C",
#                     format="%.2f",
#                 ),
#             },
#             key=f"{location_name}_editor",
#         )
...
#         st.session_state.full_spinning_df = full_df
...
def render_location_tab(location_name, full_df, source_df, wtt_path=None):
    ...
    if loc == "ANJAR":
        ...
        with sub_tabs[0]:
            st.link_button(
                "Go to Anjar",
                "https://welspunanjar.streamlit.app/"
            )
    ...
    with sub_tabs[0]:
        ...
        df = full_df[
            full_df["Location"].str.upper() == loc
        ].copy()
    ...
    with sub_tabs[3]:
        ...
        if loc == "VAPI":
            st.link_button(
                "Go to TT",
                "https://vttwelspun.streamlit.app/"
            )
